 ...
 *
 *El programa fuerza la salida del bucle si se adivina el número antes de que finalicen
 * los intentos. (sin utilizar break)
 */
package ud2_practica4_1b;
...
public class UD2_Practica4_1b {
    ...
    public static void main(String[] args) {
        ...
        while (intentos > 0) {
            ...
            //Si el numero del jugador 2 es el de jugador 1 salimos
            if (numJugador1 == numJugador2) {
                intentos = 0;
                continue;
            }

            // Si no, le decimos al jugador 2 si su número es mayor o menor que
